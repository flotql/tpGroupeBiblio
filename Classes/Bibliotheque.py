...
class Biblio:
    ...
    def importUtilisateurs(self, chemin):
        with open(chemin, "r") as lireUtilisateur:
            for i in lireUtilisateur:
                ...
                objUser = User(lesUtilisateurs[0], lesUtilisateurs[1], lesUtilisateurs[2], lesUtilisateurs[3],
                               lesUtilisateurs[5][:-1])
    ...
    def importLivres(self, chemin):
        ...
        for i in lireLivres:
            lesLivres = i.split(" ; ")
            if len(lesLivres) == 8:
                objLivre = Livre(lesLivres[0], lesLivres[1], lesLivres[2], lesLivres[3], lesLivres[4], lesLivres[5],
                                 lesLivres[6], lesLivres[7][:-1])
            else:
                objLivre = BD(lesLivres[0], lesLivres[1], lesLivres[2], lesLivres[3], lesLivres[4], lesLivres[8],
                              lesLivres[9][:-1], lesLivres[5], lesLivres[6], lesLivres[7])
